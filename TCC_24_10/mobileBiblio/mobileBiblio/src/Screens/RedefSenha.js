              ...
              <View style={{ alignItems: 'center', justifyContent: 'center', width: '100%' }}>
                ...
                <View style={{
                  ...
                  <View style={{
                    ...
                    <TouchableOpacity
      onPress={handleRedefinirSenha} // Função ao clicar
      style={{
        width: '100%',
        marginTop: hp(2), // Espaço superior
        height: hp(7), // Altura do botão
        borderRadius: 8, // Bordas arredondadas
        backgroundColor: theme.colors.primary, // Cor de fundo
        justifyContent: 'center', // Centraliza o conteúdo verticalmente
        alignItems: 'center', // Centraliza o conteúdo horizontalmente
        flexDirection: 'row', // Organiza o ícone e o texto na horizontal
        overflow: 'hidden', // Impede que o conteúdo ultrapasse os limites
      }}
    >
      {/* Ícone dentro do TouchableOpacity */}
      <IconButton
        icon="lock-reset"
        size={wp(5)} // Tamanho do ícone ajustável
        color="white"
        onPress={handleRedefinirSenha} // Função ao clicar
        style={{ marginRight: wp(2) }} // Espaçamento entre o ícone e o texto
      />
